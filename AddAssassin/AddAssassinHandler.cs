...
namespace AddAssassin
{
    public class AddAssassinHandler : ControlInterface
    {
        AddAssassin control = new AddAssassin();
        ...
        { 
            ...
            set
            {
                ...
                {
                    control.ControlRoot.Opacity = 0.5;
                    disabled = true;
                }
                else
                {
                    control.ControlRoot.Opacity = 1;
                    disabled = false;
                }
            }
        }
